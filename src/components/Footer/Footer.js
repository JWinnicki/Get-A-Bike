    ...
    return (
        <div className='Footer'>
            ...
            <div className='Footer-contact'>
                ...
                <a className='Footer-contact--link' href="https://github.com/JWinnicki" rel="noopener" target="_blank">
                    <Icon icon='github-sign' size='tiny' color='white' />
                </a>
                <a className='Footer-contact--link' href="https://www.linkedin.com/in/j%C4%99drzej-winnicki-a13921193/" rel="noopener" target="_blank">

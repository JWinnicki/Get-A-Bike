...
import DayCard from '../../../views/CheckIfAvailable/DayCard/DayCard';
import RentalSummary from '../../../views/RentFormContainer/RentalSummary/RentalSummary';
...
const mapPropsToState = ({orders, appState}) => {
